        ...
        (err, result) => {
                ...
                bcrypt.hash(req.body.password, 10, (err, hash) => {
                    if (err) {
                        ...
                        db.query(`INSERT INTO user (name, emailaddress, password, phonenumber, DOB, address, role) VALUES ('${req.body.name}', ${db.escape(req.body.email)}, ${db.escape(hash)},'${req.body.phonenumber},'${req.body.dob}','${req.body.address}','01')`,
                            (err, result) => {
                                if (err) {
                                    throw err;
